...
var storePlaCole = Ext.create('Ext.data.Store', {
    ...
    proxy: {
        ...
        api: {
            ...
            read: '/teste2/php/Planejamento/ListCadPlan.php',
            create: '/teste2/php/Planejamento/InsCadPlan.php',
            destroy: '/teste2/php/Planejamento/DelCadPlan.php'
            ...
            bbar: [
                    ...
                    listeners: {
                        ...
                        click: function() {
                            ...
                            if (parms.length > 0) {
                                //console.log('um');
                                Ext.Ajax.request({
                                    url: '/teste2/php/Planejamento/updateCadPlan.php',
                                    params: {
                                        action: 'post',
                            ...
                            if (parms1.length > 0) {
                                //console.log('dois');
                                Ext.Ajax.request({
                                    url: '/teste2/php/Planejamento/InsCadPlan.php',
                                    params: {
                                        action: 'post',
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        Ext.Ajax.request({
                            url: '/teste2/php/Planejamento/FecharPlan.php',
                            params: {
                                action: 'post',
                                numseq: vSeqpla,
                                tiptrp: vTiptrp
