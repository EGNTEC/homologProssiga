            ...
            bbar: [{
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        Ext.Ajax.request({
                            url: '/teste2/php/Prestacao/ReabPrest.php',
                            params: {
                                action: 'post',
                                id: vIdAbrt
                            },
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        Ext.create('desloc.view.CadDevolucao');
    ...
    listeners: {
        ...
        beforerender: function() {
            ...
            if (niv == 1) {
                ...
                Ext.getCmp('btn_devolucao').setDisabled(false);
            } else {
                Ext.getCmp('btn_NovoDia').destroy();
                Ext.getCmp('btn_devolucao').destroy();
            }
            //Fim tratamento
