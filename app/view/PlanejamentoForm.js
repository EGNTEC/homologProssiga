            ...
            columns: [{
                    ...
                    listeners: {
                        click: function() {
                            ...
                            Ext.Ajax.request({
                                url: '/teste2/php/Planejamento/CriarPlan.php',
                                params: {
                                    action: 'post',
                                    numseq: vSeqpla,
                                    numcad: vNumcad,
                            ...
                            if (pTiptrp == 1) {
                                ...
                                if ((niv == 3 || niv == 2 || niv == 1) && bt == 0) {
                                    Ext.create('desloc.view.CadPlanejamentoMotCoord'); //para coordenadores(Próprio)

                                } else {
                                    if (vstspla > 0) {
                                        Ext.create('desloc.view.CadPlanejamentoNoEdit'); //cadastro para Próprio
                                    } else {
                                        Ext.create('desloc.view.CadPlanejamento'); //cadastro para Próprio
            ...
            listeners: {
                ...
                itemClick: function(grid, record, item, index, e, eOpts) {
                    ...
                    /*itemdblclick:function(grid,record, item, index, e, eOpts){
                         //chamar tela de cadastro de planejamento
                            Ext.create('desloc.view.CadPlanejamento');
                          }*/
